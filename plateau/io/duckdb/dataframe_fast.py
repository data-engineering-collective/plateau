...
def read_table_as_arrow(
    ...
    # Cast specified categorical columns to dictionary (categorical) type.
    if categoricals:
        empty_table = cast_categoricals_to_dictionary(empty_table, categoricals)

    # Combine partitions with the empty table.
    ...
    # Align dictionary-encoded categorical columns across tables.
    if categoricals:
    ...
    )  # todo: can we make this strict again?
